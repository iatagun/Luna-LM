"""
Bilkent Turkish Writings Dataset'i indir, temizle ve corpus'a ekle
"""
...
def download_and_clean():
    print("Bilkent Turkish Writings Dataset indiriliyor...")
    
    try:
        ds = load_dataset("selimfirat/bilkent-turkish-writings-dataset", "default")
    except Exception as e:
        print(f"Hata: {e}")
        print("Alternatif deneniyor...")
        ds = load_dataset("selimfirat/bilkent-turkish-writings-dataset")
    ...
    for split_name in ds.keys():
        ...
        # Text column'u bul
        text_col = None
        for col in ['text', 'content', 'sentence', 'writing']:
    ...
    # Yeni dosyaya yaz
    output_file = "bilkent_writings_clean.txt"
